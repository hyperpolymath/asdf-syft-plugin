...
:url-repo: https://github.com/hyperpolymath/asdf-syft-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-syft-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-syft-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-syft-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Syft] versions.
...
Syft is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Syft versions per project

|**Project Isolation**
|Pin Syft per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Syft version
...
=== Installing Syft Versions

[source,bash]
----
asdf list all syft
asdf install syft latest
asdf install syft 0.1.0
----
...
[source,bash]
----
asdf global syft 0.1.0
asdf local syft 0.1.0
asdf current syft
syft --version
----
...
* Ensure `syft` is on PATH after installation.
* Verify the installed version with `syft --version`.
